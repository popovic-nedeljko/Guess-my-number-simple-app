...
[Gues-my-number](https://guess-my-number-simple-app.netlify.app/)

<img src='/src/img/guess_game.png' width=500 height=400> <img src='/src/img/number-phone.png' width=250 height=400>

Mini application gamein which the goal is to guess the random generated number, from 1 to 25.
